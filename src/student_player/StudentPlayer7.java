...
public class StudentPlayer7 extends PentagoPlayer {
...
//    		if(player_id == 0) {
//    			MyTools tool = new MyTools(bs, Piece.BLACK);
//    			if(bs.getTurnNumber()<10) {return white_score-1*black_score;}
//    			else
//    			{return white_score - black_score + 2*tool.stepsToWin(bs, Piece.BLACK);}
//    		}
//    		else {
//    			MyTools tool = new MyTools(bs, Piece.WHITE);
//    			if(bs.getTurnNumber()<10) {
////    				if(tool.diagCase1(bs, Piece.WHITE)==2 || tool.diagCase2(bs, Piece.WHITE)==2) {
////    					//System.out.println(tool.diagCase1(bs, Piece.WHITE) + "#" + tool.diagCase2(bs, Piece.WHITE));
////    					return Double.MAX_VALUE;
////    				}
//    				return black_score - 1.2*white_score;
//    			}
//    			else {
//    				return black_score - white_score + 2*tool.stepsToWin(bs, Piece.WHITE);
//    			}
//    		}
//    		
    		return 0;
