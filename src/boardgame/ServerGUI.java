...
public class ServerGUI extends JFrame implements BoardPanel.BoardPanelListener {
    ...
    //protected static final String[] PLAYER_CLASSES = { "pentago_swap.RandomPentagoPlayer", "student_player.StudentPlayer2" };
    protected static final String[] PLAYER_CLASSES = { "student_player.StudentPlayer", "otherpeople.Yuki" };
    //protected static final String[] PLAYER_CLASSES = { "student_player.StudentPlayer2", "student_player.StudentPlayer5" };
